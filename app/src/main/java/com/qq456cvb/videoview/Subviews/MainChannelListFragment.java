 ...
 */
public class MainChannelListFragment extends Fragment implements DateTimePickDialogUtil.OnDateSelectListener {
        ...
        txtHistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DateTimePickDialogUtil dateTimePickDialog = new DateTimePickDialogUtil(
                        MainChannelListFragment.this.getActivity(), MainChannelListFragment.this, txtHistory.getText().toString());
        ...
        final TextHttpResponseHandler handler = new TextHttpResponseHandler() {
            public void onSuccess(int statusCode, Header[] headers, String response) {
                if (response.contains(":")) {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(MainChannelListFragment.this.getActivity());
